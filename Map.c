...
//	char *startName = idToName(start);
//	char *endName = idToName(end);
   	int i;
   	int j;
   	int sea;
   	int k;
...
//    				printf("%d", j);
	...
	return j;  // to keep the compiler happy
}
